...
//        glfwWindowHint(GLFW_RESIZABLE, GLFW_FALSE);
        ...
        window = glfwCreateWindow(800, 600, "Advanced Computer Graphics in Game Development", nullptr, nullptr);
...
//        loadModel();
    ...
    void createInstance() {
        ...
        // Create Vulkan application info struct
        ...
        // Create Vulkan instance info struct
    ...
    void createLogicalDevice() {
        ...
        // Create device queue info structs
...
//            createInfo.ppEnabledLayerNames = validationLayers.data();
    ...
    void createGraphicsPipeline() {
        ...
        // Create pipeline layout info struct
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("../test_texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void drawFrame() {
        ...
        result = vkQueuePresentKHR(presentQueue, &presentInfo); // Huzzah!
